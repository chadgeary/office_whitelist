...
def lambda_handler(event, context):
  ...
  print(owl_endpoints_raw.status)
  ...
  print("service: " + '[%s]' % ', '.join(map(str,owl_service_subnets)))
  ...
  print("existing: " + '[%s]' % ', '.join(map(str, filtered_subnets)) + '[%s]' % ', '.join(map(str, filtered_subnetsv6)))
  ...
  print("adding: " + '[%s]' % ', '.join(map(str, add_subnets)))
  ...
  print("removing: " + '[%s]' % ', '.join(map(str, remove_subnets)))
  ...
  # remove ipv6
  remove_subnetsv6 = [filtered_subnetv6 for filtered_subnetv6 in filtered_subnetsv6 if filtered_subnets not in owl_service_subnets]
  print("removing: " + '[%s]' % ', '.join(map(str, remove_subnets)))
